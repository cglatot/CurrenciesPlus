...
public class CurrencyMenuPopup : WidgetPopup
{
    public bool IsDisabled { get; set; }

    protected sealed override Node Node { get; } = new() {
        Stylesheet = CurrencyPopupStyles.MenuPopupStylesheet,
        Style = new() {
            Flow    = Flow.Vertical,
            Gap     = 6,
            Padding = new(4)
    ...
    ///     The color of the text. This is used for the threshold colors
    /// </param>
    ...
    {
        Node button = CreateButtonNode(id, label, sortIndex, iconId, altText, onClick, glyphColor, textColor);
        ...
        Node button = new() {
            ...
            ChildNodes = [
                ...
                new() {
                    ...
                    InheritTags = true,
                    Style = new() {
                        Color  = textColor is not null ? textColor : new("Widget.PopupMenuText"),
                    }
                },
                new() {
                    Id          = "AltText",
